...
public interface LinkedListInterface<T> {
    ...
    /**
     * Returns the current node of the linked list
     * Current node is defaulted to the first node added unless otherwise changed
     * @return the current value at the currentItem in the linked list
     *
     */
    public T getCurrent();
    ...
    /**
     * A function that sets the current node to the current current nodes.next value
     */
    public void getNext();
    ...
    /**
     * A function that sets the current node to the current current nodes.previous value
     */
